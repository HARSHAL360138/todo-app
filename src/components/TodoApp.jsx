...
function TodoApp() {
  ...
  return (
    <div className="max-w-3xl mx-auto mt-6 p-4 sm:p-6 md:p-8 bg-gradient-to-tr from-sky-50 via-white to-purple-50 rounded-2xl shadow-xl border border-gray-200">
      <h1 className="text-3xl sm:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-purple-700 mb-6 text-center">
        Todo App
      </h1>
      ...
      <div className="flex flex-col sm:flex-row mb-6 gap-4">
        ...
        <button
          onClick={addTask}
          className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2 rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all"
        >
          Add
        </button>
      </div>

      <div className="flex flex-wrap gap-2 justify-center sm:justify-start mb-6 text-sm">
        {["all", "completed", "pending"].map((f) => (
          <button
            key={f}
            onClick={() => setFilter(f)}
